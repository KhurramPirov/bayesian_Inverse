...
from vuq._pdf_collection import PDFCollection
from vuq._gamma_pdf import GammaPDF
from vuq._uniform_nd import UniformND
...
log_p = PDFCollection([ UniformND(1) for i in range(num_input) ])
